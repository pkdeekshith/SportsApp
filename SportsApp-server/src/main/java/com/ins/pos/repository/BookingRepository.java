...
public interface BookingRepository extends CrudRepository<Booking, Long> {
	...
	@Query(value = "select b from Booking b where b.bookedDate>=:bookingStartDate and b.bookedDate<=:bookingEndDate and b.active=1 and b.bookingApp IN :bookingApp")
	...
	@Query(value = "select b from Booking b where b.bookedDate>=:bookingStartDate and b.bookedDate<=:bookingEndDate and b.centerId=:centreId and b.active=1 and b.bookingApp IN :bookingApp")
	...
	@Query(value = "select b from Booking b where b.bookedDate>=:bookingStartDate and b.bookedDate<=:bookingEndDate and b.centerId=:centreId and b.facilityId=:facilityId and b.active=1 and b.bookingApp IN :bookingApp")
	...
	@Query(value = "select b from Booking b where b.bookedDate>=:bookingStartDate and b.bookedDate<=:bookingEndDate and b.centerId=:centreId and b.facilityId=:facilityId and b.subFacilityId=:subFacilityId and b.active=1 and b.bookingApp IN :bookingApp")
